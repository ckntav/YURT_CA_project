...
all_yurt_BH %>%
  ...
  scale_color_manual(values = c("#BE8A60", "#6A2E35", "#788AA3", "#BFC9CA")) +
  scale_size_manual(values = c(0.75, 0.75, 0.75, 0.25))
...
all_yurt_BH %>%
  ...
  scale_y_continuous(breaks = c(-0.5, 0, 0.5, 0.6, 1)) +
  coord_cartesian(ylim = c(-0.5, 1)) +
  scale_color_manual(values = c("#BE8A60", "#BFC9CA")) +
...
all_yurt_BH %>%
  ...
  scale_y_continuous(breaks = c(-0.5, 0, 0.5, 0.6, 1)) +
  coord_cartesian(ylim = c(-0.5, 1)) +
  scale_color_manual(values = c("#6A2E35", "#788AA3", "#BFC9CA")) +
